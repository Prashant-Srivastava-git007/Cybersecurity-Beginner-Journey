...
| Part                     | Description                                                                  |
| ------------------------ | ---------------------------------------------------------------------------- |
| **MFTECmd.exe**          | The executable tool for analyzing NTFS Master File Tables.                   |
| **-f "C:\Users...$MFT"** | Specifies the **input MFT file** to be analyzed.                             |
| **--de 109518**          | Extracts the details of the **specific entry number (109518)** from the MFT. |
