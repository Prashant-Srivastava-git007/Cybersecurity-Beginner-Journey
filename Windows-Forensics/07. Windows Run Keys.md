...
**NOTE:**
* **RUN Keys →** Programs listed here run every time the system starts or the user logs in.
* **RUNONCE Keys →** Programs listed here run only once, then Windows automatically deletes the entry after execution.
